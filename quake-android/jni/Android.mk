...
include $(CLEAR_VARS)
LOCAL_MODULE := quake
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../android/quake/libquake.a
include $(PREBUILT_STATIC_LIBRARY)

include $(CLEAR_VARS)
LOCAL_MODULE := lfapp
LOCAL_SRC_FILES := $(LOCAL_PATH)/../../../android/quake/quake_lfapp_obj/libquake_lfapp.a
include $(PREBUILT_STATIC_LIBRARY)
...
LOCAL_STATIC_LIBRARIES := quake lfapp Box2D libpng libjpeg-turbo
